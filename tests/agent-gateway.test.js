...
test("plan service rejects Agent-authored physical actions before fact mutation", async () => {
  ...
  assert.equal(plan.agent_adjustment.reason_code, "AGENT_SERVER_OWNED_RESOURCES");
