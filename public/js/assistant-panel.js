...
import { alarmTriggerLabel } from "./alarm-labels.js";
...
function feedbackItem(event, onNavigate) {
  ...
  const message = event.type === "alarm_opened" ? alarmTriggerLabel(event.message) : event.message;
...
function panelHeader(state, client) {
  ...
  return h("header", { className: "assistant-header" }, [
    h("div", { className: "assistant-title" }, [
      h("span", { className: "assistant-channel", "aria-hidden": "true", text: "AI / 站点总线" }),
