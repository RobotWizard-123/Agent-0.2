...
function openResetDialog() {
  const content = h("div", { className: "confirmation-content" }, [
    h("p", { className: "section-kicker", text: "ADMINISTRATIVE CONFIRMATION" }),
    h("h2", { text: "重置全部演示数据？" }),
...
export function renderAudit(container, state) {
  ...
  const intro = h("section", { className: "view-intro" }, [
    h("div", {}, [h("p", { className: "section-kicker", text: "WHO / WHEN / WHAT / RESULT" }), h("h2", { text: "变更与诊断审计" }), h("p", { text: filterId ? `正在查看与 ${filterId} 相关的记录。` : "每一次方案创建、最终确认、执行、回滚和恢复验证都有可追溯记录。" })]),
  ...
  container.replaceChildren(intro, panel("审计时间线", auditTimeline(items), { kicker: "IMMUTABLE TRAIL" }));
}
