  ...
  return [
    {
      ...
      content: [
        ...
        "- rated_power_w: 非负数字，额定功率(W)，必须从用户文本提取；未提及填null",
        "- weight_kg: 非负数字，重量(kg)，必须从用户文本提取；未提及填null",
        "- network_ports: 非负整数，网口数量，必须从用户文本提取；未提及填null",
        ...
        "",
        "示例输出：",
        '{"id":"SRV-AGENT","count":1,"u_size":10,"rated_power_w":3500,"weight_kg":120,"network_ports":4,"preferred_rack_ids":[],"hostname":null,"model":null,"business":null,"owner":null}',
      ].join("\n"),
    },
  ...
  return [
    {
      ...
      content: [
        ...
        "candidate_id 只能选择输入中的已知候选或null；alternatives最多3个。",
        "备选动作只允许place_device、move_device、set_dividers，并必须包含精确start_u。",
